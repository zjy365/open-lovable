  ...
  return (
    ...
    >
      <div className="flex mb-40 justify-between items-center">
        <div className="py-4 px-8 text-#000000 text-[12px]/[16px] font-[450] bg-heat-8 rounded-6">
          Customer story
        </div>

        <div className="p-2 text-black-alpha-56 group-hover:text-#000000 transition-all group-hover:translate-x-1 group-hover:translate-y-[-1px]">
          <ArrowUp />
        </div>
      </div>
      ...
      <div className="text-title-h5 mt-31 pr-32">
        How Replit uses <span className="text-#000000">Firecrawl</span> to
        power Replit Agent
      </div>
